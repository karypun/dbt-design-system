...
export const menu = (
  <Fragment>
    <span className="govuk-caption-m" style={{marginBottom: "1em"}}>DBT plugin for GOV.UK prototype</span>
    <NavigationMenu items={[
      {
        href: '/get-started/home-office-plugin',
        text: 'Add DBT plugin to GOV.UK prototype'
      }
    ]} />
    <span className="govuk-caption-m" style={{marginBottom: "1em"}}>DBT React prototype</span>
    <NavigationMenu items={[
    ...
    <div className="govuk-grid-column-three-quarters">
      <h1>{title}</h1>
        ...
        <ul>
          ...
          <li><A href="https://www.figma.com/file/y90OmHLuhtNuCUOc7jzQlj/Home-Office-design-library-Roboto">DBT styles and components (Figma)</A></li>
        </ul>
        <h2>HTML prototype</h2>
          <h3>Public facing services</h3>
            ...
            <p>You may find some of features of the <A href="/get-started/home-office-plugin">DBT plugin</A> makes it easier and quicker to prototype.</p>
          <h3>Internal services</h3>
          <p>For internal services, such as caseworking systems, use the DBT styles (including logo, colours and internal font) in your prototypes. You can choose whether to use the:</p>
          <ul>
            <li><A href="/get-started/home-office-plugin">GOV.UK prototype kit with the DBT plugin</A></li>
            <li><A href="/get-started/start-prototype">DBT design system React prototype kit</A></li>
          </ul>
