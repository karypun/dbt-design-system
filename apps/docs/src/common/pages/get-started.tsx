...
const Page: FC<PageProps> = ({ location }) => (
  <div className="govuk-grid-row">
    ...
    <div className="govuk-grid-column-three-quarters">
      <h1>{title}</h1>
        <p>This design system helps us understand what Regulatory Services look like and how they should behave. It builds on the <A href="https://design-system.service.gov.uk/">GOV.UK design system</A>.</p>
