...
export const title = 'Up to date guidance card';
  ...
  <Helmet>
    ...
    <div className="govuk-grid-column-three-quarters">
      ...
      <div className="example example-images confirmation" style={{marginBottom: "2em"}}>
        <img src={card} className="image-examples" alt="An example of an interaction that shows contextual help" />
      </div>
      ...
      <ul>
        <li>Launching or returning a rocket or space plane: rules and regulations</li>
      </ul>
