...
export const title = 'Request for information';
const description = 'How to help users to request more information';
...
<div className="govuk-grid-row">
  <Helmet>
    ...
    <div className="govuk-grid-column-three-quarters">
      ...
      <p className="govuk-caption-m" style={{marginBottom: "2em"}}>Also known as: RFI</p>
      </div>

      <p className="govuk-body">How to help users request more information from applicants.</p>
