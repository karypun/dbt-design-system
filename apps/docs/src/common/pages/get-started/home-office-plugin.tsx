...
export const title = 'Add DBT plugin to GOV.UK prototype';
const description = 'How to generate a new prototype based on the DBT design system';
...
const Page: FC<PageProps> = ({ location }) => (
  <div className="govuk-grid-row">
    ...
    <div className="govuk-grid-column-three-quarters">
      ...
      <p>This allows you to use DBT design system components and change to the DBT styling.</p>
      <p>If you run your prototype, and go to 'Manage your prototype' (<code>/manage-prototype/templates</code>), you'll find DBT templates.</p>
      ...
      <p>To change your prototype to by default use the DBT styling:</p>
